...
import type { RoomQuestion } from '@/domain/question.types'
...
export function QuestionItem({ question }: QuestionItemProps) {
  const isGeneratingOrAnswered = question.answer || question.isGeneratingAnswer
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="flex justify-end">
            <span className="text-muted-foreground text-xs">{formatDate(question.createdAt)}</span>
          </div>
        </div>
      </CardContent>
    </Card>
